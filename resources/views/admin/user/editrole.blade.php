            ...
            <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                            ...
                            <div style="padding-top: 0px;">
                                <table>
                                    <tr>
                                        ...
                                        <td>&nbsp;</td>
                                        <td>
                                            <x-input id="name" type="text" name="name" :value="$role->name" required autofocus />
                                        </td>
                                    </tr>
                ...
                <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                    ...
                    <table class="min-w-full divide-y divide-gray-200 " align="center">
                            ...
                            @foreach($showRoles as $showRoles)
                            <tr>
                                <td class="px-6 py-4 whitespace-nowrap">{{$showRoles->id}}</td>
                                <td class="px-6 py-4 whitespace-nowrap">{{$showRoles->name}}</td>
                                <td class="px-6 py-4 text-sm">
                                    ...
                                    <td>
                                        <form action="{{ route('role.destroy',$showRoles->id) }}" method="POST">
                                            @csrf
                                            @method('delete')
